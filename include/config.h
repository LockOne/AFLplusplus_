...
#define HAVOC_CYCLES 64U       // 256U
#define HAVOC_CYCLES_INIT 64U  // 1024U
...
#define NUM_ADDITIONAL_INPUTS 512
#define FUZZ_LEVEL_LIMIT 64

#define CALLEE_MAP_SIZE (1 << 15)
#define CALLEE_SHM_ENV_VAR "__AFL_CALLEE_MAP_SHM_ID"

#define PATH_MAP_SIZE (1 << 17)
#define PATH_MAP_MAX (PATH_MAP_SIZE << 3)
#define PATH_SHM_ENV_VAR "__AFL_PATH_MAP_SHM_ID"
